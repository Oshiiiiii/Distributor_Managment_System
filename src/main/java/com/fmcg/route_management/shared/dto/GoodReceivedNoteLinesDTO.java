...
public class GoodReceivedNoteLinesDTO implements Serializable {

	private static final long serialVersionUID = -8957962043857281338L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GoodReceivedNoteLinesDTO)) {
            return false;
        }

        return id != null && id.equals(((GoodReceivedNoteLinesDTO) o).id);
    }
